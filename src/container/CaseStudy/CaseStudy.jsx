...
const CaseStudy = () => {
      return (
            <div className="app__caseStudy section__padding">
                  <Heading subTitle="CASE STUDY" mainTitle="Check My My Case Studies" />
                  <div className="app__caseStudy--caseOne">
                        <div className="row">
                              <div className="col-6 caseOne__img">
                                    <img src={images.case1} alt="case1" />
                              </div>
                              <div className="col-6 caseOne__content">
                                    ...
                                    <div className="caseOne__content--btn">Details</div>
                              </div>
                        </div>
                  </div>
                  <div className="app__caseStudy--caseTwo">
                        <div className="row">
                              <div className="col-6 caseTwo__content">
                  ...
                  <div className="app__caseStudy--caseThree">
                        <div className="row">
                              ...
                              <div className="col-6 caseThree__content">
                                    ...
                                    <div className="caseThree__content--btn">Details</div>
                              </div>
                        </div>
                  </div>
            </div>
